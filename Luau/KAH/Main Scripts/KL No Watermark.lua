...
Commands required: shield]])
    ...
    if string.sub(msg:lower(), 1, #prefix + 6) == prefix..'nmkick' then
   		...
   		if player ~= nil and not table.find(nokick, player) then
   			...
   			Chat("name "..name.. "  \n Imagine Getting \n CRASHED!!!")
   			Chat(".spamt pm " .. name .. " 😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀 😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀")
  			Remind(" Type .unspamt to stop kicking! The slower the rainbow, the more laggy they're getting!")
...
print("wmannounce - announce a message with  as the sender of the h")
...
game:GetService("RunService").RenderStepped:Connect(function()
	task.wait(0)
	    ...
	    for i, gear in pairs(v.Backpack:GetChildren()) do
				...
				Chat("ungear "..v.Name)
				Chat("punish "..v.Name)
                		Chat("h \n\n\n  Sorry, "..v.Name.. ", you cannot use gears due to anti gear (2). \n\n\n")
			end
            	end
       	    end
	    end
...
function warnGear(player, toolName)
        ...
        if isB == true then
       		Chat("ungear " .. spe)
       		Chat("punish " .. spe)
       		Chat("h \n\n\n  Sorry, " .. player.Name .. ", you cannot use tools because of anti gear. \n\n\n")
      	        Chat("clr")
	else
		Chat("ungear " .. player.Name)
       		Chat("punish " .. player.Name)
...
if table.find(cantexecute, game.Players.LocalPlayer.Name) then
		game.Players.LocalPlayer:Kick(" Oh dear, you're blacklisted from my script! How did you do that? DM me on ts2021 to appeal.") 
end
