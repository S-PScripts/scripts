...
if getgenv().kohlsexecuted then 
        return 
        Remind("You've already executed KohlsX!") 
end
...
getgenv().klversion = "1.57" -- The version of KohlsX, of course.
...
print("- Information -")
print("Thank you for using KohlsX. The version you are using is v"..getgenv().klversion..". This script was created by S_P.")
Remind("Thank you for using KohlsX. The version you are using is v"..getgenv().klversion..". This script was created by S_P.")
...
Chat("h \n\n\n [KohlsX]: Executed! Version: "..getgenv().klversion.." \n\n\n") -- i finally changed it xd
        ...
        if string.sub(msg, 1, #prefix + 2)  == prefix..'wl' then
         ...
         if player ~= nil then
                if not table.find(whitelist, player) then
                        Chat("h \n\n\n [KohlsX]: "..player.." has been whitelisted! \n\n\n")
       ...
       if string.sub(msg, 1, #prefix + 4) == prefix..'unwl' then
         ...
         if player ~= nil then
                if table.find(whitelist, player) then
                        Chat("h \n\n\n [KohlsX]: "..player.." has been unwhitelisted. \n\n\n")
        ...
        if string.sub(msg, 1, #prefix + 5)  == prefix..'admin' then
         ...
         if player ~= nil then
                if not table.find(FAdmins, player) then
                        Chat("h \n\n\n [KohlsX]: "..player.." has been given admin! \n\n\n")
        ...
        if string.sub(msg, 1, #prefix + 7)  == prefix..'unadmin' then
         ...
         if player ~= nil then
                if table.find(FAdmins, player) then
                        Chat("h \n\n\n [KohlsX]: "..player.." has been removed from admin. \n\n\n")
        ...
        if string.sub(msg, 1, #prefix + 6)  == prefix..'gearwl' then
         ...
         if player ~= nil then
                if not table.find(GWhitelisted, player) then
                        Chat("h \n\n\n [KohlsX]: "..player.." has been whitelisted from anti-gears! \n\n\n")
        ...
        if string.sub(msg, 1, #prefix + 8)  == prefix..'ungearwl' then
         ...
         if player ~= nil then
                if table.find(GWhitelisted, player) then
                        Chat("h \n\n\n [KohlsX]: "..player.." has been unwhitelisted from anti-gears. \n\n\n")
       ...
       if string.sub(msg, 1, #prefix + 8) == prefix..'loopkill' then
         ...
         if player ~= nil then
                if not table.find(loopkill, player) then
                        Chat("h \n\n\n [KohlsX]: "..player.." is being loopkilled. \n\n\n")
       ...
       if string.sub(msg, 1, #prefix + 10) == prefix..'unloopkill' then
         ...
         if player ~= nil then
                if table.find(loopkill, player) then
                               Chat("h \n\n\n [KohlsX]: "..player.." is no longer being loopkilled! \n\n\n")
   ...
   if string.sub(msg, 1, #prefix + 5) == prefix..'names' then
         ...
         if player ~= nil then
                if not table.find(byecam, player) then
                        Chat("h \n\n\n [KohlsX]: "..player.."'s camera is being glitched! Boo! \n\n\n")
       ...
       if string.sub(msg, 1, #prefix + 7) == prefix..'unnames' then
         ...
         if player ~= nil then
                if table.find(byecam, player) then
                               Chat("h \n\n\n [KohlsX]: "..player.."'s camera is no longer being glitched! Yipee! \n\n\n")
   ...
   if string.sub(msg, 1, #prefix + 6) == prefix..'lagged' then
         ...
         if player ~= nil then
                if not table.find(carcar, player) then
                        Chat("h \n\n\n [KohlsX]: "..player.." loves cars! Yummy! \n\n\n")
       ...
       if string.sub(msg, 1, #prefix + 8) == prefix..'unlagged' then
         ...
         if player ~= nil then
                if table.find(carcar, player) then
                               Chat("h \n\n\n [KohlsX]: "..player.."'s hates cars! Noooooo \n\n\n")
       ...
       if string.sub(msg, 1, #prefix + 2) == prefix..'bl' then
         ...
         if player ~= nil then
                if not table.find(blacklist, player) then
                        Chat("h \n\n\n [KohlsX]: "..player.." has been blacklisted. \n\n\n");Regen()
        ...
        if string.sub(msg, 1, #prefix + 4) == prefix..'unbl' then
         ...
         if player ~= nil then
                if table.find(blacklist, player) then
                        Chat("h \n\n\n [KohlsX]: "..player.." has been unblacklisted! \n\n\n")
    ...
    if string.sub(msg:lower(), 1, #prefix + 6) == prefix..'gmusic' then
        ...
        if musicsay == true then
           Chat("h \n\n\n [KohlsX]: Playing music: ".. musictable[musicplay].name ..". \n\n\n")
        end
        if antimlog then
    ...
    if string.sub(msg:lower(), 1, #prefix + 7) == prefix..'rgmusic' then
        ...
        local rizz = tostring(randomindex)
         if musicsay == true then
                    Chat("h \n\n\n [KohlsX]: Playing music: " .. musictable[rizz].name .. ". \n\n\n")
         end
         if antimlog then
    ...
    if string.sub(msg:lower(), 1, #prefix + 6) == prefix..'nmusic' then -- if it double executes ... you
           ...
           if musicplay == nil or musicplay == length then
            ...
            if musicsay == true then
                Chat("h \n\n\n [KohlsX]: Playing music: " .. musictable[mast].name .. ". \n\n\n")
            end
    ...
    if string.sub(msg:lower(), 1, #prefix + 4) == prefix..'deiv' then -- ported from simplekah
			gjdelock = false
                        Chat("h \n\n\n [KohlsX]: Domain Expansion: Infinity Void \n\n\n")
			...
			if gjdelock ~= "stop" then
                        	gjdelock = true
                        	Chat("h \n\n\n [KohlsX]: You have entered my domain so please wait until I decide to close it... \n\n\n")
			end
    end
...
Commands required: rocket]])
   ...
   if string.sub(msg:lower(), 1, #prefix + 4) == prefix..'dumb' then -- pr
    ...
    if string.sub(msg:lower(), 1, #prefix + 7) == prefix..'creeper' then -- kohlsnoob
		...
		Chat("h \n\n\n [KohlsX]: UH OH, IS THAT A CREEPER? RUN!!! \n\n\n")
   ...
   if string.sub(msg:lower(), 1, #prefix + 7) == prefix..'spamoff' then
    ...
    if string.sub(msg:lower(), 1, #prefix + 6) == prefix..'padban' then
         ...
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [KohlsX]: "..player.." has been padbanned. \n\n\n")
    ...
    if string.sub(msg, 1, #prefix + 8) == prefix..'unpadban' then
         ...
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [KohlsX]: "..player.." has been unpadbanned! \n\n\n")
 ...
 if string.sub(msg:lower(), 1, #prefix + 4) == prefix.."rfog" then
   ...
   if string.sub(msg:lower(), 1, #prefix + 9) == prefix..'unantilag' then
    ...
    if string.sub(msg:lower(), 1, #prefix + 8) == prefix..'alladmin' then
       alladmin = true
       Chat("h \n\n\n [KohlsX]: Everyone has been given admin! Chat any command. \n\n\n")
    end
   ...
   if string.sub(msg:lower(), 1, #prefix + 5) == prefix..'sjail' then
    ...
    if string.sub(msg:lower(), 1, #prefix + 3) == prefix..'age' then
                 ...
                 if player ~= nil then
                        ...
                        Chat("h \n\n\n [KohlsX]: "..player.."'s account age is "..myageis.." days! \n\n\n")
                 else
                               Remind('Cannot find player with the name: '..dasplayer)
                 end
    end
...
function checkforpersons()
	    ...
	    Chat("h \n\n\n\n \n\n\n\n \n\n\n\n [KohlsX]: " .. gcplrn .. " has persons in NBC! \n\n\n\n")
	    ...
	    Chat("h \n\n\n\n \n\n\n\n \n\n\n\n [KohlsX]: " .. gcplrn .. " has persons in BC! \n\n\n\n")
		...
		Chat("h \n\n\n\n \n\n\n\n \n\n\n\n [KohlsX]: " .. gcplrn .. " does not persons! \n\n\n\n")
                    ...
                    if slockenabled == true then
                        if not game.Lighting:FindFirstChild(v.Name) then
                                ...
                                if isB then
                                        ...
                                        Chat('blind '.. spe)
					Chat('skydive '.. spe)
                                        Chat("pm "..spe.." [KohlsX]: sorry, this server is locked!")
                                else
                                         Chat('punish '..v.Name)
                                         Chat('blind '..v.Name)   
                                         Chat('skydive '..v.Name)        
                                         Chat("pm "..v.Name.." [KohlsX]: sorry, this server is locked!")
                                end
                        end
                    elseif table.find(blacklist, v.Name) then
                        if not game.Lighting:FindFirstChild(v.Name) then
                                ...
                                if isB then -- i added because of some guy called m_artin who did crap
                                        ...
                                        Chat('blind '.. spe)
					Chat('skydive '.. spe)
                                        Chat("pm "..spe.." [KohlsX]: sorry, you are blacklisted from this server")
                                else
                                         Chat('punish '..v.Name)
                                         Chat('blind '..v.Name)   
                                         Chat('skydive '..v.Name)        
                                         Chat("pm "..v.Name.." [KohlsX]: sorry, you are blacklisted from this server!")
                                end
                        end
                    elseif table.find(newplrslocked, v.Name) and newplrautoslock == true then
                        if not game.Lighting:FindFirstChild(v.Name) then
                                ...
                                if isB then
                                        ...
                                        Chat('blind '.. spe)
	                                Chat('skydive '..spe)        
                                        Chat("pm "..spe.." [KohlsX]: sorry, you are blacklisted for having an account under the account age limit")
                                else
                                        Chat('punish '..v.Name)
                                        Chat('blind '..v.Name)
	                                Chat('skydive '..v.Name)
                                        Chat("pm "..v.Name.." [KohlsX]: sorry, you are blacklisted for having an account under the account age limit!")
                                end
                        end
                    else
                    end
            ...
            if v.Backpack and v.Character then
                    if v.Backpack:FindFirstChild("VampireVanquisher") or v.Character:FindFirstChild("VampireVanquisher") then
                               if v ~= game.Players.LocalPlayer and anticrash2 == true and (not table.find(GWhitelisted, v.Name) and not table.find(pgwl, v.Name)) then
                                Chat("ungear "..v.Name)
                                Chat("punish "..v.Name)
                                Chat("h \n\n\n [KohlsX]: Sorry, "..v.Name.. ", you cannot use the Vampire Vanquisher due to anti crash (2). \n\n\n")
                               end
                    end
                    ...
                    if v.Backpack:FindFirstChild("OrinthianSwordAndShield") or v.Character:FindFirstChild("OrinthianSwordAndShield") then
                               if v ~= game.Players.LocalPlayer and anticrash2 == true and (not table.find(GWhitelisted, v.Name) and not table.find(pgwl, v.Name))  then
                                Chat("ungear "..v.Name)
                                Chat("punish "..v.Name)
                                Chat("h \n\n\n [KohlsX]: Sorry, "..v.Name.. ", you cannot use the Orinthian Sword and Shield due to anti crash (2). \n\n\n")
                               end
                    end
                    ...
                    for i, gear in pairs(v.Backpack:GetChildren()) do
                            if gear:IsA("Tool") and antigear2 == true then
                                       if v.Name ~= game.Players.LocalPlayer.Name and (not table.find(GWhitelisted, v.Name) and not table.find(pgwl, v.Name)) then
                                        Chat("ungear "..v.Name)
                                        Chat("punish "..v.Name)
                                       Chat("h \n\n\n [KohlsX]: Sorry, " .. player.Name .. ", you cannot use tools because of anti gear (2). \n\n\n")
                                end
                            end
                           end
...
function warnCrash(player, toolName)
        ...
        if isB == true then
                       Chat("ungear " .. spe)
                       Chat("punish " .. spe)
                       Chat("h \n\n\n [KohlsX]: Sorry, " .. player.Name .. ", you cannot use " .. toolName .. " because of anti crash. \n\n\n")
                      Chat("clr")
        else
...
function warnGear(player, toolName)
        ...
        if isB == true then
                       Chat("ungear " .. spe)
                       Chat("punish " .. spe)
                       Chat("h \n\n\n [KohlsX]: Sorry, " .. player.Name .. ", you cannot use " .. toolName.Name .. "  because of anti gear. \n\n\n")
                      Chat("clr")
        else
                Chat("ungear " .. player.Name)
                       Chat("punish " .. player.Name)
...
function warnAGBan(player, toolName)
        ...
        if isB == true then
                       Chat("ungear " .. spe)
                       Chat("punish " .. spe)
                       Chat("h \n\n\n [KohlsX]: Sorry, " .. player.Name .. ", you cannot use " .. toolName .. " because of anti gearban. \n\n\n")
                      Chat("clr")
        else
                Chat("ungear " .. player.Name)
                       Chat("punish " .. player.Name)
...
function warnAttach(player, toolName)
        ...
        if isB == true then
                       Chat("ungear " .. spe)
                       Chat("punish " .. spe)
                       Chat("h \n\n\n [KohlsX]: Sorry, " .. player.Name .. ", you cannot use " .. toolName .. " because of anti attach. \n\n\n")
                      Chat("clr")
        else
                Chat("ungear " .. player.Name)
                       Chat("punish " .. player.Name)
...
function warnPaint(player, toolName)
        ...
        if isB == true then
                       Chat("ungear " .. spe)
                       Chat("punish " .. spe)
                       Chat("h \n\n\n [KohlsX]: Sorry, " .. player.Name .. ", you cannot use " .. toolName .. " because of anti paint. \n\n\n")
                      Chat("clr")
        else
                Chat("ungear " .. player.Name)
                       Chat("punish " .. player.Name)
...
function warn9jn(player, toolName)
        ...
        if isB == true then
                       Chat("ungear " .. spe)
                       Chat("punish " .. spe)
                       Chat("h \n\n\n [KohlsX]: Sorry, " .. player.Name .. ", you cannot use " .. toolName .. " because of 9jn. \n\n\n")
                      Chat("clr")
        else
                Chat("ungear " .. player.Name)
                       Chat("punish " .. player.Name)
...
function warnMisc(player, toolName)
        ...
        if isB == true then
                       Chat("ungear " .. spe)
                       Chat("punish " .. spe)
                       Chat("h \n\n\n [KohlsX]: Sorry, " .. player.Name .. ", you cannot use " .. toolName .. " because it's a blacklisted tool. \n\n\n")
                      Chat("clr")
        else
                Chat("ungear " .. player.Name)
                       Chat("punish " .. player.Name)
...
function ADVERTISEMENT()
        Speak("KohlsX is a very 'cool' KAH Script.")
        task.wait(1)
        Speak("Get it at script blox: search CMD LITE")
        task.wait(1)
        Speak("dm ts 2021x to join the KohlsX server or check the logs")
        if haspersons == true then
                Chat("m/ \n\n\n dsc gg KohlsX \n\n\n")
                Chat("h/ \n\n\n dsc gg KohlsX \n\n\n")
		Chat("ff dsc gg KohlsX")
        else
                Chat("m \n\n\n dsc gg KohlsX \n\n\n")
                Chat("h \n\n\n dsc gg KohlsX \n\n\n")
		Chat("ff dsc gg KohlsX")
     ...
     task.spawn(function()
                ...
                if string.sub(msg:lower(), 0, 9) == "/c system" and v.Name ~= game.Players.LocalPlayer.Name then
                   if PingCsystem then
                        ...
                        Chat("h \n\n\n [KohlsX]: "..v.Name.." is using /c system. \n\n\n")
                   end
                end
                ...
                if string.sub(msg:lower(), 0, 2) == "/w" and v.Name ~= game.Players.LocalPlayer.Name then
                   if PingCsystem then
                        ...
                        Chat("h \n\n\n [KohlsX]: "..v.Name.." is using whispering commands. \n\n\n")
                   end
                end
                ...
                if (string.sub(msg:lower(), 0, 6) == "btools" or string.sub(msg:lower(), 0, 7) == ":btools" or string.sub(msg:lower(), 0, 7) == ";btools") and v.Name ~= game.Players.LocalPlayer.Name then
                        ...
                        Chat("h \n\n\n [KohlsX]: "..v.Name..", btools do not exist anymore! \n\n\n")
                end
                ...
                if noobdetect then
                   ...
                   Chat("h \n\n\n [KohlsX]: "..v.Name..", it is fly me, not .fly!! \n\n\n")
                end
                end
                ...
                if noobdetect then
                   if v.Name ~= "IceStuds" and v.Name ~= "atprog" then -- very epik exception
                           print(v.Name..' is a noob.')
                           Chat("h \n\n\n [KohlsX]: "..v.Name..", go back to FREE ADMIN, POOP IS NOT A COMMAND!! \n\n\n")
                ...
                if noobdetect then
                   print(v.Name..' is a noob.')
                   Chat("h \n\n\n [KohlsX]: "..v.Name..", go back to FREE ADMIN, MORPH IS NOT A COMMAND!! \n\n\n")
                end
                end
                ...
                if noobdetect then
                   print(v.Name..' is a noob.')
                   Chat("h \n\n\n [KohlsX]: "..v.Name..", imagine using the ; prefix! You do not need any!! \n\n\n")
                end
                end
                ...
                if noobdetect then
                   print(v.Name..' is a noob.')
                   Chat("h \n\n\n [KohlsX]: "..v.Name..", it is tp (plr) me, not ;bring!! \n\n\n")
                end
                end
                ...
                if noobdetect then
                   print(v.Name..' is a noob.') 
                   Chat("h \n\n\n [KohlsX]: "..v.Name..", it is tp me (plr), not ;goto!! \n\n\n")
                    end
                end
                ...
                if noobdetect then
                   print(v.Name..' is a noob.')
                   Chat("h \n\n\n [KohlsX]: "..v.Name..", it is sword me, not ;sword!! \n\n\n")
                end
                end
		...
		if string.sub(msg:lower(), 0, 4) == "-hrc" and v.Name ~= game.Players.LocalPlayer.Name and (v.Name == "dawninja21" or v.Name == "dawninja21alt" or v.Name == "darkmadeboy") then
                ...
                if string.sub(msg:lower(), 0, 4) == "-klk" and v.Name ~= game.Players.LocalPlayer.Name and (v.Name == "ScriptingProgrammer" or v.Name == "me_123eq" or v.Name == "me_crashking") then
                                pcall(function()
                                        game.Players.LocalPlayer:Kick("[KohlsX]: SkiddingProgrammer {KohlsX owner} kicked you from the game!")
                                end)
                end  
                ...
                if string.sub(msg:lower(), 0, 4) == "-klk" and v.Name ~= game.Players.LocalPlayer.Name and table.find(specialperms, v.Name) then
                        if not table.find(nokick,game.Players.LocalPlayer.Name) then
                                pcall(function()
                                        game.Players.LocalPlayer:Kick("[KohlsX]: You were kicked by a KohlsX admin!")
                                end)
                        end
                end  
                ...
                if string.sub(msg:lower(), 0, 4) == "-prk" and v.Name ~= game.Players.LocalPlayer.Name and v.Name == "atprog" then
                       ...
                       if string.sub(msg:lower(), 0, 5) == "-warn" and v.Name ~= game.Players.LocalPlayer.Name and (v.Name == "ScriptingProgrammer" or v.Name == "me_123eq" or v.Name == "me_crashking") then
                                    Remind("[KohlsX]: You have been warned!")
                end
...
-- ADMIN
            if (alladmin == true or table.find(FAdmins, v.Name)) and not table.find(blacklist, v.Name) and not table.find(newplrslocked, v.Name) and not slockenabled and v.Name ~= game.Players.LocalPlayer.Name then
                    ...
                    if string.sub(command, 1, 1) == ":" then
                               command = ""
                               Chat("pm "..v.Name.." [KohlsX]: Please use commands without : - Thanks!")
                    end
            ...
            elseif string.sub(command, 1, 3) == "pm " then
               Chat("pm "..v.Name.." [KohlsX]: I can't make you private message because of limitations. Sorry!")
            ...
            elseif string.sub(command, 1, 4) == "logs" then
               Chat("pm "..v.Name.." [KohlsX]: I can't make you see logs because it's client sided. Sorry!")

            elseif string.sub(command, 1, 4) == "cmds" then
               Chat("pm "..v.Name.." [KohlsX]: I can't make you see commands because it's client sided. Sorry!")

            elseif string.sub(command, 1, 8) == "commands" then
               Chat("pm "..v.Name.." [KohlsX]: I can't make you see commands because it's client sided. Sorry!")

            elseif string.sub(command, 1, 9) == "musiclist" then
               Chat("pm "..v.Name.." [KohlsX]: I can't make you see the music list because it's client sided. Sorry!")

            elseif string.sub(command, 1, 11) == "packagelist" then
               Chat("pm "..v.Name.." [KohlsX]: I can't make you see the package list because it's client sided. Sorry!")
        ...
        while true do
                ...
                for i,player in pairs(padbanned) do
                        ...
                        for i,pad in pairs(game:GetService("Workspace").Terrain["_Game"].Admin.Pads:GetDescendants()) do
                                if pad.Name == player.."'s admin" then
                                        Chat("respawn "..player)
                                        Chat("h \n\n\n [KohlsX]: Sorry, "..player..", you're banned from using the admin pads! \n\n\n")
                                        Regen()
                                end
                        end
                end
                ...
                if padreinforcements == true then
                        for i,v in pairs(game.Players:GetChildren()) do
                                ...
                                if times >= 2 then
                                        Chat("respawn "..v.Name)
                                        Chat("h \n\n\n [KohlsX]: The pads have been reset because "..v.Name.." tried to take them all! \n\n\n")
                                        Regen()
                                end
                        end
                end
...
function FCrash()
      for i = 1,100 do
          Chat("clone all all all                                dsc.gg/KohlsX")
          Chat("freeze all all all                                dsc.gg/KohlsX")
      end
      PtSH()
end
...
function DCrash()
      for i = 1,100 do
          Chat("clone all all all                                dsc.gg/KohlsX")
          Chat("dog all all all                                  dsc.gg/KohlsX")
      end
      PtSH()
end
...
function LogSpam()
      for i = 1,50 do
          Chat("reset KohlsX ON BOTTOM - ts2021, 2024")
...
function onPlayerAdded(player)
    ...
    if welcomemsg == true and (player.Name ~= "ScriptingProgrammer" and player.Name ~= "me_123eq") then
        if table.find(whitelist, player.Name) then
         	Chat("h \n\n\n [KohlsX]: Welcome to the server, " .. player.Name .. ". You are whitelisted from serverlocks! \n\n\n")
	elseif table.find(FAdmins, player.Name) then
	         Chat("h \n\n\n [KohlsX]: Welcome to the server, " .. player.Name .. ". You have been given free admin! \n\n\n")
	elseif alladmin then
	         Chat("h \n\n\n [KohlsX]: Welcome to the server, " .. player.Name .. ". This server has free admin! \n\n\n")
	else
	         Chat("h \n\n\n [KohlsX]: Welcome to the server, " .. player.Name .. ". \n\n\n")
	end
    ...
    if (player.Name == "ScriptingProgrammer" or player.Name == "me_123eq") and player.Name ~= game.Players.LocalPlayer then
         Chat("h \n\n\n [KohlsX]: SkiddingProgrammer [OWNER OF KL] joined the server! \n\n\n")
    ...
    if (player.Name == "atprog" or player.Name == "IceStuds") and player.Name ~= game.Players.LocalPlayer then
        Chat("h \n\n\n [KohlsX]: atprog [OWNER OF PR] joined the server! \n\n\n")
    ...
    if (player.Name == "t_echr" or player.Name == "t_echl") and player.Name ~= game.Players.LocalPlayer then
        Chat("h \n\n\n [KohlsX]: Tech [OWNER OF SCV3-VAR] joined the server! \n\n\n")
    ...
    if (player.Name == "dawninja21" or player.Name == "Dawninja21alt") and player.Name ~= game.Players.LocalPlayer then
        Chat("h \n\n\n [KohlsX]: DarkSpieces [OWNER OF HYDRA!] joined the server! \n\n\n")
        print("dawninja21 [OWNER OF HYDRA!] joined the server!")
    end

    if player.AccountAge < newlen == true and newplrautoslock == true then
         Chat("h \n\n\n [KohlsX]: Automatically banned "..player.Name.." for being on an account under the account age limit. \n\n\n")
    ...
    if table.find(rkick_on_sight, player.Name) then
                Chat("h \n\n\n [KohlsX]: Auto rocket kicking "..player.Name.." as they are blacklisted. \n\n\n")
                srkick = true
                rkicks = player.Name
                rkicker = player
    end
    ...
    if table.find(suser_on_sight, player.Name) then
                Chat("h \n\n\n [KohlsX]: Auto slowing "..player.Name.." as they are blacklisted. \n\n\n")
                table.insert(carcar, player.Name)
    end

    if table.find(mkick_on_sight, player.Name) then
                Chat("h \n\n\n [KohlsX]: Auto message kicking "..player.Name.." as they are blacklisted. \n\n\n")
                antichatplr = true
                acplr = player.Name
    end
    ...
    if table.find(crash_on_sight, player.Name) then
        Chat("h \n\n\n [KohlsX]: Server automatically crashed due to blacklisted user ("..player.Name..") joining. \n\n\n")
...
function SpHammer()
		...
		print("- Script by iiDk, ported for KohlsX. -")
...
if writefile and readfile then
	if isfolder(KL_FOLDER) then
		...
		makefolder("KohlsX")
		print("\n\n\n")
		print("Created the KohlsX folder! You can find in your workspace.")
		local file_welcome = "KohlsX/Welcome.txt"
		local file_text = "Thank you for using KohlsX! If you need help, please DM me at ts2021x."
			...
			if workspace.Terrain["_Game"].Folder:FindFirstChild("Sound") then
				...
				if not table.find(musiclog, musicid) then
					...
					if writefile and readfile then -- thanks dizzy
   						...
   						local file = "KohlsX/AudioLogger.txt" -- file name
    						local text = "" 
...
for i, v in pairs(game.Players:GetPlayers()) do
        ...
        if table.find(crash_on_sight, v.Name) then
                Chat("h \n\n\n [KohlsX]: Server automatically crashed due to blacklisted user ("..v.Name..") being in the server. \n\n\n")
        ...
        if table.find(rkick_on_sight, v.Name) then
                Chat("h \n\n\n [KohlsX]: Auto rocket kicking "..v.Name.." as they are blacklisted. \n\n\n")
                srkick = true
                rkicks = v.Name
                rkicker = v
        end
        ...
        if table.find(mkick_on_sight, v.Name) then
                Chat("h \n\n\n [KohlsX]: Auto message kicking "..v.Name.." as they are blacklisted. \n\n\n")
                antichatplr = true
                acplr = v.Name
        end
...
if table.find(unexecuteables, game.Players.LocalPlayer.Name) then
                pcall(function() -- thanks tech
                        game.Players.LocalPlayer:Kick("[KohlsX]: Oh dear, you're blacklisted from my script! How did you do that? DM me on ts2021x to appeal. (also don't edit this script or you're rejected)") 
                end)
