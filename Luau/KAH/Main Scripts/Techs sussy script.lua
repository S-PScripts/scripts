...
|_   _| ____/ ___| | | ( ) ___|  / ___|| | | / ___/ ___\ \ / /
  | | |  _|| |   | |_| |/\___ \  \___ \| | | \___ \___ \\ V / 
  | | | |__| |___|  _  |  ___) |  ___) | |_| |___) |__) || |  
 _|_| |_____\____|_|_|_|_|____/__|____/ \___/|____/____/ |_|  
/ ___| / ___|  _ \|_ _|  _ \_   _|                            
\___ \| |   | |_) || || |_) || |                              
 ___) | |___|  _ < | ||  __/ | |                              
|____/ \____|_| \_\___|_|    |_|  v1.091 ]]

if _G.executed then 
	return 
	Remind("You've already executed Tech's Sussy Script!") 
end
...
game.Players.LocalPlayer.Chatted:Connect(function(msg)
	...
	if string.sub(msg, 1, #prefix + 2)  == prefix..'wl' then
         ...
         if player ~= nil then
                Chat("h \n\n\n [Tech's Sussy Script]: "..player.." has been whitelisted! \n\n\n")
       ...
       if string.sub(msg, 1, #prefix + 4) == prefix..'unwl' then
         ...
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [Tech's Sussy Script]: "..player.." has been unwhitelisted. \n\n\n")
	...
	if string.sub(msg, 1, #prefix + 5)  == prefix..'admin' then
         ...
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [Tech's Sussy Script]: "..player.." has been given admin! \n\n\n")
	...
	if string.sub(msg, 1, #prefix + 7)  == prefix..'unadmin' then
         ...
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [Tech's Sussy Script]: "..player.." has been removed from admin. \n\n\n")
	...
	if string.sub(msg, 1, #prefix + 6)  == prefix..'gearwl' then
         ...
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [Tech's Sussy Script]: "..player.." has been whitelisted from anti-gears! \n\n\n")
	...
	if string.sub(msg, 1, #prefix + 8)  == prefix..'ungearwl' then
         ...
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [Tech's Sussy Script]: "..player.." has been unwhitelisted from anti-gears. \n\n\n")
	...
	if string.sub(msg, 1, #prefix + 8)  == prefix..'unfogvis' then -- guys is this FONALC
       ...
       if string.sub(msg, 1, #prefix + 8) == prefix..'loopkill' then
         ...
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [Tech's Sussy Script]: "..player.." is being loopkilled. \n\n\n")
       ...
       if string.sub(msg, 1, #prefix + 10) == prefix..'unloopkill' then
         ...
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [Tech's Sussy Script]: "..player.." is no longer being loopkilled! \n\n\n")
       ...
       if string.sub(msg, 1, #prefix + 2) == prefix..'bl' then
         ...
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [Tech's Sussy Script]: "..player.." has been blacklisted. \n\n\n")
        ...
        if string.sub(msg, 1, #prefix + 4) == prefix..'unbl' then
         ...
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [Tech's Sussy Script]: "..player.." has been unblacklisted! \n\n\n")
	...
	if string.sub(msg, 1, #prefix + 12)  == prefix..'personsusers' then
       ...
       if string.sub(msg:lower(), 1, #prefix + 5) == prefix..'slock' then
        Chat("h \n\n\n [Tech's Sussy Script]: Server is locked! \n\n\n")
        slockenabled = true
       end
    
       if string.sub(msg:lower(), 1, #prefix + 7) == prefix..'unslock' then
        slockenabled = false
        Chat("h \n\n\n [Tech's Sussy Script]: Server is unlocked! \n\n\n")
        Chat('unblind all')
        Chat('unpunish all')
       end
    ...
    if string.sub(msg:lower(), 1, #prefix + 6) == prefix..'gmusic' then
	    ...
	    if dontannounce == false then
            	Chat("h \n\n\n [Tech's Sussy Script]: Playing music: " .. musicnames[musicplay] .. ". \n\n\n")
	    end
	    if antimlog then
    ...
    if string.sub(msg:lower(), 1, #prefix + 4) == prefix..'deiv' then -- ported from simplekah
		        Chat("h \n\n\n [Tech's Sussy Script]: Domain Expansion: Infinity Void \n\n\n")
    ...
    if string.sub(msg:lower(), 1, #prefix + 7) == prefix..'tropics' then  -- ported from simplekah
		     local gjpfgend = 0
                     ...
                     Chat("h \n\n\n [Tech's Sussy Script]: Hollow Purple! \n\n\n")
...
Commands required: rocket]])
  ...
  if string.sub(msg:lower(), 1, #prefix + 6) == prefix..'ecrash' then
	    ...
	    Chat("h \n\n\n [Tech's Sussy Script]: This server was crashed because of an issue. \n\n\n")
	    task.wait(0.5)
            Chat("fogcolor 0 0 0")
	    Chat("time 0")
            Chat("fogend 0")
    ...
    if string.sub(msg:lower(), 1, #prefix + 6) == prefix..'padban' then
	 local dasplayer = string.sub(msg:lower(), #prefix + 8)
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [Tech's Sussy Script]: "..player.." has been padbanned. \n\n\n")
    ...
    if string.sub(msg, 1, #prefix + 8) == prefix..'unpadban' then
         ...
         PLAYERCHECK(dasplayer)
         if player ~= nil then
                Chat("h \n\n\n [Tech's Sussy Script]: "..player.." has been unpadbanned! \n\n\n")
    ...
    if string.sub(msg, 1, #prefix + 8) == prefix..'padreinf' then
       Chat("h \n\n\n [Tech's Sussy Script]: Pad reinforcements are on. \n\n\n")
       padreinforcements = true
    end

    if string.sub(msg, 1, #prefix + 10) == prefix..'unpadreinf' then
       Chat("h \n\n\n [Tech's Sussy Script]: Pad reinforcements are off! \n\n\n")
   ...
   if string.sub(msg:lower(), 1, #prefix + 9) == prefix..'unautoafk' then
    ...
    if string.sub(msg:lower(), 1, #prefix + 8) == prefix..'adminall' then
       alladmin = true
       Chat("h \n\n\n [Tech's Sussy Script]: Everyone has been given admin! Chat any command. \n\n\n")
    end
    ...
    if string.sub(msg:lower(), 1, #prefix + 3) == prefix..'age' then
			...
			myageis = cplr.AccountAge
                	Chat("h \n\n\n [Tech's Sussy Script]: "..player.."'s account age is "..myageis.." days! \n\n\n")
         	else
               		Remind('Cannot find player with the name: '..dasplayer)
         	end
    end
    ...
    if string.sub(msg:lower(), 1, #prefix + 10) == prefix..'unadminall' then
       alladmin = false
	Chat("h \n\n\n [Tech's Sussy Script]: Free admin is off. \n\n\n")
    end
...
function CMDPrint()
print("---Command list for Tech's Sussy Script v1.080---")
...
print("wmannounce - announce a message with [Tech's Sussy Script]: as the sender of the h")
        ...
        if v.Name ~= game.Players.LocalPlayer.Name and not table.find(whitelist, v.Name) then
            for i, player in ipairs(players) do
				...
				if isB then
                                	Chat('punish '.. spe)
                                	Chat('blind '.. spe)
                                	Chat("pm '..spe..' [Tech's Sussy Script]: sorry, but your bypassed username will not prevent you from getting locked in this server!")
				else
					 Chat('punish '..v.Name)
                               		 Chat('blind '..v.Name)	
				...
				if isB then -- i added because of some guy called m_artin who did shit
                                	Chat('punish '.. spe)
                                	Chat('blind '.. spe)
                                	Chat("pm '..spe..' [Tech's Sussy Script]: sorry, but your bypassed username will not prevent you from getting blacklisted in this server!")
				else
					 Chat('punish '..v.Name)
                               		 Chat('blind '..v.Name)	
					 Chat("pm '..v.Name..' [Tech's Sussy Script]: sorry, you are blacklisted from this server!")
				end
                        end
			...
			if not game.Lighting:FindFirstChild(v.Name) then
				...
				if isB then
                                	Chat('punish '.. spe)
                                	Chat('blind '.. spe)
                                	Chat("pm '..spe..' [Tech's Sussy Script]: sorry, you are blacklisted for having an account under the account age limit!")
				else
                                	Chat('punish '..v.Name)
                                	Chat('blind '..v.Name)
                                	Chat("pm '..v.Name..' [Tech's Sussy Script]: sorry, you are blacklisted for having an account under the account age limit!")
				end
                        end
		    else
                    end
...
task.spawn(function()
	...
	task.wait(0.1)
		...
		if antichatplr == true then
			if haspersons == true then
          			Chat("pm/ "..acplr.." [Tech's Sussy Script]: 😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀")
			else
				Chat("pm "..acplr.." [Tech's Sussy Script]: 😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀😀😃😄😁😆😅😂🤣😭💀💀💀💀💀💀💀💀💀")
			end
		end
...
game:GetService("RunService").RenderStepped:Connect(function()
	task.wait(0)
        for i, v in ipairs(game.Players:GetPlayers()) do
            if v.Backpack:FindFirstChild("VampireVanquisher") or v.Character:FindFirstChild("VampireVanquisher") then
               if v ~= game.Players.LocalPlayer and anticrash2 == true and not table.find(GWhitelisted, v.Name) then
                Chat("ungear "..v.Name)
                Chat("punish "..v.Name)
                Chat("h \n\n\n [Tech's Sussy Script]: Sorry, "..v.Name.. ", you cannot use the Vampire Vanquisher due to anti crash (2). \n\n\n")
               end
            end
            ...
            if v.Backpack:FindFirstChild("OrinthianSwordAndShield") or v.Character:FindFirstChild("OrinthianSwordAndShield") then
               if v ~= game.Players.LocalPlayer and anticrash2 == true and not table.find(GWhitelisted, v.Name) then
                Chat("ungear "..v.Name)
                Chat("punish "..v.Name)
                Chat("h \n\n\n [Tech's Sussy Script]: Sorry, "..v.Name.. ", you cannot use the Orinthian Sword and Shield due to anti crash (2). \n\n\n")
               end
            end
	    ...
	    for i, gear in pairs(v.Backpack:GetChildren()) do
				...
				Chat("ungear "..v.Name)
				Chat("punish "..v.Name)
                		Chat("h \n\n\n [Tech's Sussy Script]: Sorry, "..v.Name.. ", you cannot use gears due to anti gear (2). \n\n\n")
			end
            	end
       	    end
     end 
...
function warnCrash(player, toolName)
       ...
       Chat("h \n\n\n [Tech's Sussy Script]: Sorry, " .. player.Name .. ", you cannot use " .. toolName .. " because of anti crash. \n\n\n")
       Chat("clr")
end
...
function warnGear(player, toolName)
       Chat("ungear " .. player.Name)
       Chat("punish " .. player.Name)
       Chat("h \n\n\n [Tech's Sussy Script]: Sorry, " .. player.Name .. ", you cannot use that gear because of anti gear. \n\n\n")
...
function warnAGBan(player, toolName)
       Chat("ungear " .. player.Name)
       Chat("punish " .. player.Name)
       Chat("h \n\n\n [Tech's Sussy Script]: Sorry, " .. player.Name .. ", you cannot use " .. toolName .. " because of anti gear ban. \n\n\n")
       Chat("clr")
end
...
function warnAttach(player, toolName)
       Chat("ungear " .. player.Name)
       Chat("punish " .. player.Name)
       Chat("h \n\n\n [Tech's Sussy Script]: Sorry, " .. player.Name .. ", you cannot use " .. toolName .. " because of anti attach. \n\n\n")
       Chat("clr")
end
...
function warnPaint(player, toolName)
       Chat("ungear " .. player.Name)
       Chat("punish " .. player.Name)
       Chat("h \n\n\n [Tech's Sussy Script]: Sorry, " .. player.Name .. ", you cannot use " .. toolName .. " because of anti paint. \n\n\n")
       Chat("clr")
end
...
function warnMisc(player, toolName)
       Chat("ungear " .. player.Name)
       Chat("punish " .. player.Name)
       Chat("h \n\n\n [Tech's Sussy Script]: Sorry, " .. player.Name .. ", you cannot use " .. toolName .. " because it's a blacklisted tool. \n\n\n")
       Chat("clr")
end
...
function ADVERTISEMENT()
	Speak("Tech's Sussy Script is a very 'cool' KAH Script. Get it today on git-hub: S-PScripts or my purple: ts2021")
end
     ...
     task.spawn(function()
		task.wait(0)
                ...
                if string.sub(msg:lower(), 0, 9) == "/c system" and v.Name ~= game.Players.LocalPlayer.Name then
                   if PingCsystem then
                        ...
                        Chat("h \n\n\n [Tech's Sussy Script]: '..v.Name..' is using /c system. \n\n\n")
                   end
                end
		...
		if string.sub(msg:lower(), 0, 2) == "/w" and v.Name ~= game.Players.LocalPlayer.Name then
                   if PingCsystem then
                        ...
                        Chat("h \n\n\n [Tech's Sussy Script]: '..v.Name..' is using whispering commands. \n\n\n")
                   end
                end
                ...
                if (string.sub(msg:lower(), 0, 4) == "logs" or string.sub(msg:lower(), 0, 5) == ":logs") and v.Name ~= game.Players.LocalPlayer.Name then
                   if PingLogs then
                        ...
                        Chat("h \n\n\n [Tech's Sussy Script]: '..v.Name..' is using logs. \n\n\n")
                   end
        		   if AntiLogs then
            			LogSpam()
        		   end
		...
		if string.sub(msg:lower(), 0, 6) == "btools" or string.sub(msg:lower(), 0, 7) == ":btools" or string.sub(msg:lower(), 0, 7) == ";btools" then
                        ...
                        Chat("h \n\n\n [Tech's Sussy Script]: '..v.Name..', btools do not exist anymore! \n\n\n")
                end
        	...
        	if (string.sub(msg:lower(), 0, 3) == "sit" or string.sub(msg:lower(), 0, 4) == ":sit") and v.Name ~= game.Players.LocalPlayer.Name then
                   if antiattach then
                     ...
                     Chat("h \n\n\n [Tech's Sussy Script]: '..v.Name..', You cannot sit due to anti-attach \n\n\n")
                   end
                end
                ...
                if (string.sub(msg:lower(), 0, 4) == "stun" or string.sub(msg:lower(), 0, 5) == ":stun") and v.Name ~= game.Players.LocalPlayer.Name then
                   if antiattach then
                     ...
                     Chat("h \n\n\n [Tech's Sussy Script]: '..v.Name..', you cannot stun due to anti-attach \n\n\n")
                   end
                end
		...
		if noobdetect then
                   ...
                   Chat("h \n\n\n [Tech's Sussy Script]: '..v.Name..', it is fly me, not ;fly!! \n\n\n")
                end
		end
		...
		if noobdetect then
		   if v.Name ~= "IceStuds" and v.Name ~= "atprog" then -- very epik exception
                   	print(v.Name..' is a noob.')
                   	Chat("h \n\n\n [Tech's Sussy Script]: '..v.Name..', go back to FREE ADMIN, POOP IS NOT A COMMAND!! \n\n\n")
		...
		if noobdetect then
                   print(v.Name..' is a noob.')
                   Chat("h \n\n\n [Tech's Sussy Script]: '..v.Name..', go back to FREE ADMIN, MORPH IS NOT A COMMAND!! \n\n\n")
                end
		end
		...
		if noobdetect then
                   print(v.Name..' is a noob.')
                   Chat("h \n\n\n [Tech's Sussy Script]: '..v.Name..', imagine using the ; prefix! You do not need any!! \n\n\n")
                end
		end
		...
		if noobdetect then
                   print(v.Name..' is a noob.')
                   Chat("h \n\n\n [Tech's Sussy Script]: '..v.Name..', it is tp (plr) me, not ;bring!! \n\n\n")
                end
		end
		...
		if noobdetect then
                   print(v.Name..' is a noob.') 
                   Chat("h \n\n\n [Tech's Sussy Script]: '..v.Name..', it is tp me (plr), not ;goto!! \n\n\n")
            	end
		end
...
-- ADMIN
            if (alladmin == true or table.find(FAdmins, v.Name)) and not table.find(blacklist, v.Name) and not table.find(newplrslocked, v.Name) and not slockenabled and v.Name ~= game.Players.LocalPlayer.Name then
            	...
            	if string.sub(command, 1, 1) == ":" then
              	 	command = ""
               		Chat("pm "..v.Name.." [Tech's Sussy Script]: Please use commands without : - Thanks!")
            	end
            ...
            elseif string.sub(command, 1, 3) == "pm " then
               Chat("pm "..v.Name.." [Tech's Sussy Script]: I can't make you private message because of limitations. Sorry!")
            ...
            elseif string.sub(command, 1, 4) == "logs" then
               Chat("pm "..v.Name.." [Tech's Sussy Script]: I can't make you see logs because it's client sided. Sorry!")
          
            elseif string.sub(command, 1, 4) == "cmds" then
               Chat("pm "..v.Name.." [Tech's Sussy Script]: I can't make you see commands because it's client sided. Sorry!")
          
            elseif string.sub(command, 1, 8) == "commands" then
               Chat("pm "..v.Name.." [Tech's Sussy Script]: I can't make you see commands because it's client sided. Sorry!")
          
            elseif string.sub(command, 1, 9) == "musiclist" then
               Chat("pm "..v.Name.." [Tech's Sussy Script]: I can't make you see the music list because it's client sided. Sorry!")
          
            elseif string.sub(command, 1, 11) == "packagelist" then
               Chat("pm "..v.Name.." [Tech's Sussy Script]: I can't make you see the package list because it's client sided. Sorry!")
	...
	while true do
		...
		for i,player in pairs(padbanned) do
			...
			for i,pad in pairs(game:GetService("Workspace").Terrain["_Game"].Admin.Pads:GetDescendants()) do
				if pad.Name == player.."'s admin" then
					Chat("respawn "..player)
					Chat("h \n\n\n [Tech's Sussy Script]: Sorry, "..player..", you're banned from using the admin pads! \n\n\n")
					Regen()
				end
			end
		end
		...
		if padreinforcements == true then
			for i,v in pairs(game.Players:GetChildren()) do
				...
				if times >= 2 then
					Chat("respawn "..v.Name)
					Chat("h \n\n\n [Tech's Sussy Script]: The pads have been reset because "..v.Name.." tried to take them all! \n\n\n")
					Regen()
				end
			end
		end
...
function LogSpam()
      for i = 1,50 do
	  Chat("ff Tech's Sussy Script ON BOTTOM - ts2021, 2024")
...
function GetPing()
   ...
   Speak("[Tech's Sussy Script]: Ping is " .. RSP .. "ms.")
end
...
function onPlayerAdded(player)
    ...
    if player.AccountAge < newlen == true and newplrautoslock == true then
	 Chat("h \n\n\n [Tech's Sussy Script]: Automatically banned "..player.Name.." for being on an account under the account age limit. \n\n\n")
    ...
    if table.find(rkick_on_sight, player.Name) then
		Chat("h \n\n\n [Tech's Sussy Script]: Auto rocket kicking "..player.Name.." as they are blacklisted. \n\n\n")
		srkick = true
		rkicks = player.Name
		rkicker = player
		RKick()   
	...
	if table.find(suser_on_sight, player.Name) then
		Chat("h \n\n\n [Tech's Sussy Script]: Auto slowing "..player.Name.." as they are blacklisted. \n\n\n")
		caruser = player.Name
		SlowP = true
    end

    if table.find(mkick_on_sight, player.Name) then
		Chat("h \n\n\n [Tech's Sussy Script]: Auto message kicking "..player.Name.." as they are blacklisted. \n\n\n")
		antichatplr = true
		acplr = player.Name
    end

    if table.find(crash_on_sight, player.Name) then
	Chat("h \n\n\n [Tech's Sussy Script]: Server automatically crashed due to blacklisted user ("..player.Name..") joining. \n\n\n")
	DCrash()  
    end
...
function onPlayerLeaving(player)
    ...
    if welcomemsg == true then
    	 Chat("h \n\n\n [Tech's Sussy Script]: Goodbye, " .. player.Name .. ". \n\n\n")
