 -- KOHLSLITE BY /
-- CREDITS TO MANY (tech, random stuff from 
...
print("Thank you for using KohlsLite. Created by .")
...
print("---")
print("KohlsLite, since 2023. Created by ")
...
Speak("KohlsLite THE BEST SCRIPT GET IT NOW AT MY GITHUB OR CONTACT ME ON PURPLE SITE ")
end
...
plr.Chatted:Connect(function(msg)
     task.spawn(function()
		...
		if message:lower() == "-kohlslite check" and v == "" and v ~= game.Players.LocalPlayer then
			Speak("I'm using KohlsLite!")
		end

		if message:lower() == "-kohlslite kick" and v == "" and v ~= game.Players.LocalPlayer then
			game.Players.LocalPlayer:Kick("[KohlsLite]: You were kicked by [OWNER]: .") -- feel free to remove this and the cmd above, this is probably only for if i obfuscate this at a later date.
		end
...
local function onPlayerAdded(player)
    ...
    if player.Name == "" and player.Name ~= game.Players.LocalPlayer then
	 Chat("h \n\n\n [KohlsLite]: !!! Is that ? WOW! IT IS! \n\n\n")
	 print(" [OWNER] joined the server!!!")
    end
