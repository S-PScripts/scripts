...
game.Players:Chat("gear me 00000000000000000000000000000000000000000018474459")
    ...
    wait(0.50)
		coroutine.wrap(function()
			colorAPI.colorHouse({
				wallsC = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
				baseC = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
				roofC = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
				WANDDC = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
				stairsC = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
				floorC = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
				rooftsC = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
				chiC = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere))
			})
		end)()
    spawn(function()
	colorAPI.colorBuildingBricks({
		DarkStoneGrey = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
		DeepBlue = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
		NY = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
		IW = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
		LimeGreen = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
		MSG = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
		RB = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
		TP = colorAPI.transformToColor3(BrickColor.new(_G.ColourHere)),
